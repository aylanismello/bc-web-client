...
const BCProgressiveImage = ({ max_width, artwork_url, children, active, isCollectionItem }) => {
        ...
        {(loadedSrc, loading) => {
          return loading ? (
            ...
            <img
              ...
              className={`BCProgressiveImage-img ${opaque} ${isCollectionItem && 'BCWeeklyItem-cover-image'}`}
              alt={artwork_url}
              src={loadedSrc}
              width="100%"
              height="auto"
